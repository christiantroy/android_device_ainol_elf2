...
class EdifyGenerator(object):
  ...
  def FormatUbiPartition(self, partition):
    """Format the given partition, specified by its mount point (eg,
    "/system")."""
  ...
  def AddToZip(self, input_zip, output_zip, input_path=None):
    ...
    if input_path is None:
      PROPRIETARY_DIR = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../proprietary/'))
      data = open(os.path.join(PROPRIETARY_DIR, "updater")).read()
    else:
