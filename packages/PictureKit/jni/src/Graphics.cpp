...
int unregister_android_graphics_Graphics(JNIEnv* env)
{
	env->DeleteGlobalRef(gRect_class);
	gRect_class = NULL;
	env->DeleteGlobalRef(gRectF_class);
	gRectF_class = NULL;
	env->DeleteGlobalRef(gPoint_class);
	gPoint_class = NULL;
	env->DeleteGlobalRef(gPointF_class);
	gPointF_class = NULL;
	env->DeleteGlobalRef(gBitmap_class);
	gBitmap_class = NULL;
	env->DeleteGlobalRef(gBitmapConfig_class);
	gBitmapConfig_class = NULL;
	env->DeleteGlobalRef(gCanvas_class);
	gCanvas_class = NULL;
	env->DeleteGlobalRef(gPaint_class);
	gPaint_class = NULL;
	env->DeleteGlobalRef(gPicture_class);
	gPicture_class = NULL;
	env->DeleteGlobalRef(gRegion_class);
	gRegion_class = NULL;
    return 0;
}