...
class ZLAndroidColorOptionView extends ZLAndroidOptionView {
	...
	private class ComponentView extends LinearLayout {
		...
		ComponentView(Context context, String labelText, int initialValue) {
			...
			addView(label, new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
			addView(myLeftLeftButton, new LayoutParams(40, 40));
			addView(myLeftButton, new LayoutParams(40, 40));
			addView(myValueView, new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
	...
	void addAndroidViews() {
		if (myContainer == null) {
			...
			layout.addView(myRedView, new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
			layout.addView(myGreenView, new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
			layout.addView(myBlueView, new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
    
			myColorArea = new View(context);
			layout.setPadding(20, 0, 20, 0);
			myColorArea.setMinimumHeight(60);
			myColorArea.setBackgroundColor(ZLAndroidColorUtil.argb(color));
			layout.addView(myColorArea, new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.FILL_PARENT));
