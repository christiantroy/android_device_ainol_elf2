...
class ZLAndroidSpinOptionView extends ZLAndroidOptionView {
	...
	void addAndroidViews() {
		...
		if (mySpinView == null) {
			...
			layout.addView(minusButton, new LinearLayout.LayoutParams(40, LayoutParams.WRAP_CONTENT));
			layout.addView(data, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
			layout.addView(plusButton, new LinearLayout.LayoutParams(40, LayoutParams.WRAP_CONTENT));
