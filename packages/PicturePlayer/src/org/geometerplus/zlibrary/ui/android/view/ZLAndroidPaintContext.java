...
public final class ZLAndroidPaintContext extends ZLPaintContext {
	...
	ZLAndroidPaintContext(Canvas canvas, int width, int height, int scrollbarWidth) {
		...
		PorterDuffXfermode  pdXferMode = new PorterDuffXfermode(android.graphics.PorterDuff.Mode.CLEAR);
		myFillPaint.setXfermode(pdXferMode);
		
	}

	//Override
	public void clear(ZLColor color) {
		myFillPaint.setColor(ZLAndroidColorUtil.argb(color));
		myCanvas.drawRect(0, 0, myWidth + myScrollbarWidth, myHeight, myFillPaint);
		Log.v("CLEAR",""+myWidth+"_"+myHeight+"_"+ZLAndroidColorUtil.rgb(color)+"_"+ZLAndroidColorUtil.argb(color));
	}
	...
	public void setTextColor(ZLColor color) {
		myTextPaint.setColor(ZLAndroidColorUtil.argb(color));
	}

	//Override
	public void setLineColor(ZLColor color, int style) {
		// TODO: use style
		myLinePaint.setColor(ZLAndroidColorUtil.argb(color));
	}
	//Override
	...
	public void drawPage()
	{
		...
		canvas.drawText(data,1820*2/3, 1045*2/3, paint);		
	}
}
