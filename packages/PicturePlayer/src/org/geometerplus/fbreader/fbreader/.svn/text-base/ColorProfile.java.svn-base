...
public class ColorProfile {
	...
	private ColorProfile(String name) {
		if (NIGHT.equals(name)) {
			BackgroundOption =
				new ZLColorOption("Colors", name + ":Background", new ZLColor(0, 0, 0, 0xff));
			SelectionBackgroundOption =
				new ZLColorOption("Colors", name + ":SelectionBackground", new ZLColor(82, 131, 194, 0xff));
			HighlightingOption =
				new ZLColorOption("Colors", name + ":Highlighting", new ZLColor(96, 96, 128, 0xff));
			RegularTextOption =
				new ZLColorOption("Colors", name + ":Text", new ZLColor(192, 192, 192, 0xff));
			HyperlinkTextOption =
				new ZLColorOption("Colors", name + ":Hyperlink", new ZLColor(60, 142, 224, 0xff));
		} else {
			BackgroundOption =
				new ZLColorOption("Colors", name + ":Background", new ZLColor(255, 255, 255, 0xff));
			SelectionBackgroundOption =
				new ZLColorOption("Colors", name + ":SelectionBackground", new ZLColor(82, 131, 194, 0xff));
			HighlightingOption =
				new ZLColorOption("Colors", name + ":Highlighting", new ZLColor(255, 192, 128, 0xff));
			RegularTextOption =
				new ZLColorOption("Colors", name + ":Text", new ZLColor(0, 0, 0, 0xff));
			HyperlinkTextOption =
				new ZLColorOption("Colors", name + ":Hyperlink", new ZLColor(60, 139, 255, 0xff));
		}
	}
}
